	...
	m_iSceneNum(sceneNum)
{
	...
	case 0:
		...
		m_pWalls.push_back(new Plane("Objs/roundPlane.obj", glm::vec3(2.0f, 0.0f, 2.0f), glm::vec3(0.0f), glm::vec3(9.0f, 0.01f, -9.0f), "Texture/realred.png"));				// ����

		m_pGlasses.push_back(new Plane("Objs/Plane.obj", glm::vec3(1.0f, 0.0f, 20.0f), glm::vec3(0.0f, 0.0f, 90.0f), glm::vec3(0.0f, 0.5f, 0.0f), "Texture/alphablue.png"));		// �߾� �и���
		m_pGlasses.push_back(new Plane("Objs/Plane.obj", glm::vec3(4.0f, 0.0f, 20.0f), glm::vec3(0.0f, 0.0f, 90.0f), glm::vec3(0.0f, 3.8f, 0.0f), "Texture/alphablue.png"));		// �߾� �и���
	...
	case 1:
		...
		m_pWalls.push_back(new Plane("Objs/roundPlane.obj", glm::vec3(2.0f, 0.0f, 2.0f), glm::vec3(0.0f), glm::vec3(7.0f, 6.0f, -9.0f), "Texture/realred.png"));				// ����
		m_pGlasses.push_back(new Plane("Objs/Plane.obj", glm::vec3(2.0f, 0.0f, 2.0f), glm::vec3(0.0f), glm::vec3(7.0f, 5.99f, -9.0f), "Texture/alphablue.png"));			// ������ ����
		m_pGlasses.push_back(new Plane("Objs/Plane.obj", glm::vec3(2.0f, 0.0f, 2.0f), glm::vec3(0.0f), glm::vec3(-9.0f, 8.0f, 7.0f), "Texture/alphablue.png"));			// ť�� ��
		m_pGlasses.push_back(new Plane("Objs/Plane.obj", glm::vec3(10.0f, 0.0f, 20.0f), glm::vec3(0.0f, 0.0f, 90.0f), glm::vec3(0.0f, 3.0f, 0.0f), "Texture/alphablue.png"));			// �߾Ӻи���
		break;
	case 2:
